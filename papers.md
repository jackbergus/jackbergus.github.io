...
* S. Agostinelli, **G. Bergami**, A. Fiorenza, F. M. Maggi, A. Marrella, and F. Patrizi. “[Leveraging Model Learning to Discover the Behavior of Declarative Process Models](https://icpmconference.org/2021/declarative-process-discovery-with-model-learning/)". ICPM'21 ([**Source Code**](https://github.com/bpm-diag/DECMOL)).
* **G. Bergami**, F. M. Maggi, M. Montali, and R. Peñaloza. “[Probabilistic Trace Alignments](https://icpmconference.org/2021/probabilistic-trace-alignment/)". Submitted Paper ([preprint](https://arxiv.org/abs/2107.03997), [ICPM'21 Demo](https://youtu.be/aWhS7yOa0UA)).
