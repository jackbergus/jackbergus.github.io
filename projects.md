...
As a Graduate (G), Undergraduate (U), and PhD (P) student, I developped the following code:
   ...
   * (G) [SocialSim](https://github.com/jackbergus/socialsim): a dynamic (Social) Network Simulator using both agent model and event model simulation  (feat. *Elena Tea Russo*).
